    ...
    window.jsPlumbLoadTest = {
        ...
        run : function() {
            ...
            for (var i = 0; i < elements.length; i++) {
                ...
                instance.addGroup({el:elements[i]})
            }

            t2 = new Date().getTime();
            var addGroupsTotal = t2 - t;
            ...
            html("totalCreateTime", (repaintTotal + addEndpointTotal + connectTotal + createElementTotal + addGroupsTotal) + "ms");
            ...
            html("groupCreateTime", (addGroupsTotal) + "ms");
            html("averageGroupCreateTime", (addGroupsTotal / elements.length) + "ms");
