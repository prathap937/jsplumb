...
// export class EndpointImpl<E = any> extends Component implements Endpoint {
//
...
//
//     getXY() {
//         return { x:this.representation.x, y:this.representation.y }
//     }
//
...
//     maxConnections:number
//
//     proxiedBy:EndpointImpl<E>
//
//     connectorClass:string
//     connectorHoverClass:string
//
//     finalEndpoint:EndpointImpl<E>
//
//     enabled = true
//
//     isSource:boolean
...
//     currentAnchorClass:string
//
//     referenceEndpoint:EndpointImpl<E>
//
//     edgeType:string
//     connector:ConnectorSpec
//     connectorOverlays:Array<OverlaySpec>
...
//                 Endpoints.removeClass(this, oldAnchorClass)
//                 Endpoints.addClass(this, anchorClass)
