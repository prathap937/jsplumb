(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.jsPlumbConnectorFlowchart = {}, global.jsPlumb, global.jsPlumbUtil));
    ...
    function writeSegments(fc, paintInfo) {
      ...
      for (var i = 0; i < fc.internalSegments.length - 1; i++) {
        ...
        if (fc.cornerRadius > 0 && current[4] !== next[4]) {
          ...
          core._addSegment(fc, core.SEGMENT_TYPE_STRAIGHT, {
            x1: current[0],
            y1: current[1],
            x2: current[2],
            y2: current[3]
          });
          core._addSegment(fc, core.SEGMENT_TYPE_ARC, {
            r: radiusToUse,
            x1: current[2],
            y1: current[3],
            x2: next[0],
    ...
    var FlowchartConnectorHandler = {
      ...
      create: function create(connection, connectorType, params) {
        var base = core.createConnectorBase(connectorType, connection, params, [30, 30]);
      ...
      exportGeometry: function exportGeometry(connector) {
        return core.defaultConnectorHandler.exportGeometry(connector);
      },
      importGeometry: function importGeometry(connector, g) {
        return core.defaultConnectorHandler.importGeometry(connector, g);
      },
    ...
    core.Connectors.register(CONNECTOR_TYPE_FLOWCHART, FlowchartConnectorHandler);
